...
class StoryMenuState extends MusicBeatState
{
	...
	/*	['Tutorial'],
		...
		['Senpai', 'Roses', 'Thorns'],*/
		['Amateur', 'Community', 'Improvisansdo'],
	];
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				...
				//Testing cutscenes for future updates.
				/*switch (curWeek){
					case 0:
						LoadingState.loadAndSwitchState(new VideoState("assets/videos/teaser/weekm.webm", new PlayState()));
					default:
						LoadingState.loadAndSwitchState(new PlayState(), true);
				}*/
			});
